...
const GATEWAY_WS_DIAG_FLAG = 'tnyma-ai:gateway-ws-diagnostic';
...
function shouldLogApiRequests(): boolean {
  try {
    return import.meta.env.DEV || window.localStorage.getItem('tnyma-ai:api-log') === '1';
  } catch {

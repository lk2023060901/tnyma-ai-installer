...
/**
 * Get TnymaAI config directory
 */
export function getTnymaAIConfigDir(): string {
  return join(homedir(), '.tnyma-ai');
}

/**
 * Get TnymaAI logs directory
 */

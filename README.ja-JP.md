...
Feishu チャンネルは、App ID / App Secret の手動入力に加えて、Channels ページから QR ログインしてボット作成、権限付与、イベント購読、公開まで自動化するフローにも対応しました。QQ Bot チャンネルも App ID / Client Secret の手動入力を残したまま、同じ Channels ページから QR でワンクリック作成できるようになりました。

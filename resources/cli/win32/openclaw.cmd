...
if /i "%1"=="update" (
    echo openclaw is managed by TnymaAI ^(bundled version^).
    echo.
    echo To update openclaw, update TnymaAI:
    echo   Open TnymaAI ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=TnymaAI
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\TnymaAI.exe" "%OPENCLAW_ENTRY%" %*
)
